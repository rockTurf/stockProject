package com.srj.common.template.utils;
...
public class PoiUtil {
	...
	//不带标题导出excel
	public static void writeExcelWithOutTitle(List data, OutputStream os, Map<String, String> titleMap){
	...
	public static void setValue(Sheet sheet, int r, int c, Object value, CellStyle style, int cellType, float rowHeight){
		...
		if(value == null){
		...
		}else if(value instanceof Number){//double or float
			...
			if(style == null) cell.setCellStyle(getFormat(sheet.getWorkbook(), "yyyy/MM/dd"));
