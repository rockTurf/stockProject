...
import com.srj.common.template.bean.TempCell;
import com.srj.common.template.tags.Tag;
import com.srj.common.template.utils.PoiUtil;
import com.srj.common.template.utils.TagUtil;
...
public class PoiTemplate {
	...
	public void setValue(TempCell tempCell){
		...
		PoiUtil.setValue(sheet, moveRow + tempCell.row, moveColumn + tempCell.column, value, tempCell.style, tempCell.column, tempCell.rowHeight);
	}
